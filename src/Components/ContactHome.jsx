    ...
    return (
        <div id="contractHome" className="py-20">
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-6">
                <div className="rounded-xl shadow-md p-9 hover:shadow-2xl hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="space-y-5">
                        <form ref={form} onSubmit={sendEmail}>
                            ...
                            <br />
                            <input type="text" placeholder="Write your name" className="input input-bordered w-full max-w-xs border bg-[#1b1b1b] focus:border-white text-white" name="user_name" required />
                            <br />
                            <label className="text-[#959595]">Email:</label>
                            <br />
                            <input type="email" placeholder="Type your Email" className="input input-bordered w-full max-w-xs bg-[#1b1b1b] focus:border-white text-white" name="user_email" required />
                            <br />
                            <label className="text-[#959595]">Message:</label>
                            <br />
                            <textarea name="message" className="textarea textarea-bordered w-80 bg-[#1b1b1b] focus:border-white text-white" placeholder="Write your message..." required />
                            <br />
                            <button className="rounded-md border-2 border-[#959595] text-[#959595] p-3">Send Message</button>
                        </form>
                    </div>
                </div>
                <div className="bg-[#1b1b1b] rounded-xl shadow-md p-9 hover:shadow-2xl hover:scale-105 transition-transform duration-300">
