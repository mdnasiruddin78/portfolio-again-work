...
const DetailsPage = () => {
    ...
    return (
        <div className="w-11/12 mx-auto lg:px-16">
            <div className="card group bg-lime-100 rounded-md shadow-md">
                ...
                <div className="p-5 space-y-4">
                    ...
                    <div className="space-x-4">
                        <a href={live_link}><button className='btn px-7 rounded-full bg-slate-800 text-xl text-white'><FaLink />Live Link</button></a>
                        <a href={github_link}><button className='btn px-7 rounded-full bg-green-600 text-xl text-white'><IoLogoGithub />
                        GitHub Link</button></a>
                    </div>
                </div>
            </div>
            <Link to={'/'} className='btn mt-5 mb-5 rounded-md border-2 border-blue-500 text-blue-400 hover:bg-blue-500 hover:text-white hover:border-blue-500'>Go To Home</Link>
        </div>
    );
};
